    ...
    wlqData = {
        init: function(){
            ...
            var columns = [
                    ...
                    },
                    {
                        ...
                        render : function(data, type, row, meta) {
                            ...
                            ret_html='<a href="/wirelessm/wlquerydata/showinfo/'+row.details.id+'/"  data-target="#commonLgWin" data-toggle="modal"  >'+row.details.numbersth+'</a>&nbsp;';
                            return ret_html;
            ...
            for(var i = 0; i < table.length; i++){
                ...
                if(parseInt(i-11) > parseInt(tday)){
