        ...
        updateFence: function (fenceId_shape, flag) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var fencetype = features[0].getProperties().fencetype;
                    var fencename = features[0].getProperties().name;
                    var belongto = features[0].getProperties().belongto;
                    var dma_no = features[0].getProperties().dma_no;
                    var description = features[0].getProperties().description;
                    var pgeojson = data.pgeojson;
                    console.log(pgeojson);

                    editing_fenceId = features[0].getProperties().shapeId;
