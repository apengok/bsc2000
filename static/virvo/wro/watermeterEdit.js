    ...
    waterMeterEdit = {
        ...
        valueChange:function () { // 判断值是否改变
            ...
            if (numbersth != edit_numbersth || buildingname != edit_buildingname || roomname != edit_roomname || communityid != edit_communityid
                ...
                || useraddr != edit_useraddr|| installsite != edit_installsite|| metertype != edit_metertype) {
                    flag1 = true;
            } else { // 表单值没有发生改变
        ...
        initSimCard: function (url) {
            waterMeterEdit.initDataList(simInput, url, simCardId,waterMeterEdit.simsChange);
        },
