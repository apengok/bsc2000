    ...
    concentratormap = {
        ...
        userTree : function(){
            ...
            treeSetting = {
                ...
                callback : {
                    onAsyncSuccess: concentratormap.AsyncSuccess,
        ...
        showMaker_single:function(name){
            
            for(var i = 0;i<markerList.length;i++){
                m = markerList[i].getProperties()
                if(m["properties"].name == name)
                {
                    var polygon = markerList[i].getGeometry();
                    // console.log(polygon)
        ...
        zTreeOnClick: function(event, treeId, treeNode){
            ...
            if(treeNode.otype == "community"){
                concentratormap.showMaker_single(treeNode.name)
