(function (window, $) {
    ...
    addCentratorManagement = {
        ...
        InitCallback: function(){
            //sim卡
            addCentratorManagement.initSimCard("/api/devm/simcard/getSimcardSelect/");
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var suggest=dataInput.bsSuggest({
                        ...
                        // console.log(keyword.id,keyword.key)

                        // var commut_id = keyword.id;
                        var url="/devm/concentrator/repetition_commaddr/";
                        
                        var parameter={"commaddr": keyword.key};
                        json_ajax("POST",url,"json",false,parameter, addCentratorManagement.deviceAjax);
                        //限制输入
        ...
        nameValidates: function () {
            ...
            if (name == "") {
                ...
                addCentratorManagement.namerepetion();
            }
        ...
        deviceAjax: function (data) {
            ...
            // $.ajax({
            //         type: "post",
            //         url: "/devm/concentrator/repetition_commaddr/",
            //         data: {commaddr:commaddr},
            //         success: function (d) {
            //             var result = $.parseJSON(d);
            //             // if (!result) {
            //             if (result.success == false) {
            //                 commaddrError.html("集中器已存在！");
            //                 commaddrError.show();
            //                 deviceFlag = false;
            //             }
            //             else {
    ...
    $(function () {
        ...
        // $("#sims").bind("input propertychange change", addCentratorManagement.deviceAjax );
        
        $("#name").bind("input propertychange change", addCentratorManagement.namerepetion );
