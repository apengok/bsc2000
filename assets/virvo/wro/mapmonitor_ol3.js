  ...
  trackPlayback = {
    ...
    dmagroupdiv:function(level){
        ...
        for(var i = 0;i<childNodes.length;i++){
            ...
            // }
            if(childNodes[i].otype == "dma" && childNodes[i].dmalevel == level){
    ...
    textClicked:function(belongto_cid,clicked_dma_no){
        ...
        for(var i = 0;i<childNodes.length;i++){
            if(childNodes[i].otype == "dma" && childNodes[i].dmalevel == "3"){
...
var crtLayerXYZ = function(type, proj, opacity){
  var layer = new ol.layer.Tile({
       source: new ol.source.XYZ({
...
var crtLayerWMTS = function(type, proj, opacity){
...
// var center = [latitude,longitude];
  ...
  var vec_layer = crtLayerXYZ("vec_c","EPSG:4326",1);
        ...
        var sat_data =crtLayerWMTS("cia_c","EPSG:4326",1);
