...
// pengwl 
	 ...
	 *       }
        ...
        var _toSettings = function (mixed) {
            ...
            else if (typeof mixed === 'object'){ //pengwl2020-07-01
                return [settings[0]]; 
            }
...
function tg_createTable(tg_table) {
    ...
    // var ordering = tg_table.ordering;
    ...
    myDataTable = $('#' + tg_table.dataTableDiv).DataTable({
        ...
        "ordering": tg_table.ordering, // 禁用排序
        // 服务端
        "processing": false,
        "serverSide": true,
        "drawCallback": function (settings) {
...
var TG_Tabel = {
    createNew: function (option) {
        ...
        tg_table.ordering = option.ordering == undefined ? false : option.ordering;
        tg_table.order = option.order;
        // 成功后回调
