...
P.PlotEdit.prototype.controlPointMouseDownHandler = function(e){
    ...
    ol.events.listen(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.controlPointMouseMoveHandler, this);
    ol.events.listen(this.mapViewport, P.Event.EventType.MOUSEUP, this.controlPointMouseUpHandler, this);
};
